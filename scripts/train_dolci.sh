...
dataset=dakopi/dolci_think__train_${samples}
...
wandb_group=olmo_dolci_v2

# model=Qwen/Qwen3-8B-Base
# tokenizer=Qwen/Qwen3-8B
# wandb_group=qwen3_dolci_v2


val_set=dakopi/dolci_think__val
lr=2e-5



for epochs in 256; do
...
for epochs in 4; do
for samples in 200 400 800 1600 3200 6400 12800; do
sleep 2
run
done
done
...
for epochs in 2; do
for samples in 200 400 800 1600 3200 6400 12800 25600; do
sleep 2
run
done
done
...
for epochs in 1; do
for samples in 200 400 800 1600 3200 6400 12800 25600 51200; do
sleep 2
run
done
done
